...
import com.AG_AP.electroshop.viewModels.ListOrderViewModel
...
fun ListOrderView(
    ...
    Row(
        ...
        Column(
            ...
            ListOrderColumn(viewModel, dataUiState, navController)
        }
    }
}
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ScaffoldListOrder(
    viewModel: ListOrderViewModel = viewModel(),
    navController: NavHostController
) {
    ...
    Scaffold(
        ...
        Box(modifier = Modifier.padding(innerPadding)) {
            ListOrderView(innerPadding, viewModel, navController)
        }
    }
}
...
fun ListOrderColumn(
    ...
    LazyColumnOrder(dataUiState.ListOrder, navController)
...
fun LazyColumnOrder(data: List<OrderFireBase?>, navController: NavHostController) {
    LazyColumn {
        items(data) { item ->
            ...
            ElevatedCardOrder(item, navController)
        }
    }
}
